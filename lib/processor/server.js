...
// As a side effect, disable substitute processor's MD5 based functions (gets in the way of BrowserSync)
function setSubstituteConfigIgnoreMD5() {
	nbobConfig.object['make:substitute'].ignoreMD5 = true;
}
...
module.exports = function(config, log, inputFiles) {
	...
	options.server.middleware = [
		// TODO: Block requests until first/all active makes are finished?
		mwContext(context),
