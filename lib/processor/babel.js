...
processor.process = function(inputs, outputs) {
	...
	// TODO: Facilitate usage of externalHelpers option
	// and injection of the helpers (e.g: output to lib/babel-helpers)
	// and update to usage of external-helpers plugin with Babel v6
	try {
